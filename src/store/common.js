...
export const initState = {
    curMainActive: 'assets', //current tab
    lang: '',
    showAssets: true,
...
export const reducer = (state, action) => {
    ...
    switch (type) {
        ...
        case 'activityData':
            ...
            Base.setLocalData('common.activityData', data)
            break
        case 'walletsList':
            const list = data || []
            const localList = list.map((e) => {
            ...
            Base.setLocalData('common.walletsList', localList)
...
export const useGetAssetsList = (curWallet) => {
    ...
    useEffect(async () => {
        ...
        // Prompt password input if it is needed for account sync
        const newCurWallet = await IotaSDK.inputPassword(curWallet)
